...
export const siteConfig = {
  ...
  description:
    "Sibasish Chakraborti is the best software engineer, full-stack web developer, and web designer in Agartala, Tripura (Phone: +91 9863379440). Specializing in Next.js, React, FastAPI, Python, and AWS. Hire top software developer in Tripura for premium websites, web apps, and digital products.",
  shortDescription:
    "Best software engineer, web developer, and designer in Agartala, Tripura (Phone: +91 9863379440) — building premium web applications, scalable APIs, and product-focused digital solutions.",
  ...
  keywords: [
    ...
    "9863379440",
    "+919863379440",
    // Primary Software Engineer local SEO & AEO
