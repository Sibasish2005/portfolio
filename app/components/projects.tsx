...
export default function ProjectsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-[94vw] md:w-[92vw] max-w-[1700px] h-[85vh] md:h-[82vh] rounded-[32px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.8)] border border-white/[0.08]">
        {portfolioProjects.map((project, index) => {
          ...
          return (
            <article
              ...
              className="project-panel absolute inset-0 w-full h-full flex flex-col md:flex-row overflow-hidden rounded-[32px]"
            >
              ...
              <div className="relative z-10 w-full md:w-[45%] h-1/2 md:h-full flex flex-col justify-between p-8 md:p-14 lg:p-20 pointer-events-none -translate-y-6 translate-x-4 md:-translate-y-12 md:translate-x-8">
                ...
                <div className="flex flex-col justify-end mt-auto">
                  ...
                  <h3
                    ...
                    className="project-content-stagger text-5xl md:text-6xl lg:text-[6rem] leading-[0.95] font-bold text-white tracking-tight drop-shadow-[0_4px_20px_rgba(0,0,0,0.6)] mb-6"
                  >
                    {project.name}
                  </h3>
                ...
                <div className="flex flex-col gap-10 md:gap-8 lg:gap-10 w-full max-w-lg mx-auto md:ml-auto md:mr-0">
                  <div className="flex gap-6 project-content-stagger group">
                    ...
                    <div className="flex-1 pb-8 border-b border-white/[0.08]">
                      ...
                      <p className="text-sm md:text-[15px] leading-relaxed font-light text-white/90 drop-shadow-md">
                        {project.problem}
                      </p>
                    </div>
                  </div>
